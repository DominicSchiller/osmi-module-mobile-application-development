 ...
 * @since 03.07.17
 *
 * This class provides a soft ease in interpolation.
 * @see TypeEvaluator
 */

public class CircleEaseInEvaluator implements TypeEvaluator<Number> {
     ...
     */
    public CircleEaseInEvaluator(float duration) {
        mDuration = duration;
    }
